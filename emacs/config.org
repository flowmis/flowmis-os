...
- grep etc. sind bereits vorinstalliert, aber falls es hier Probleme gibt kann ich vll auch mal nach einem Paket mit ripgrep (rg) suchen, da ich in doom mit dem Befehl rg gearbeitet habe.
#+begin_src elisp
