...
|           |             |       |          |         |       |           |           |
| sent      | 888         | bytes | received |      17 | bytes | 1.810,00  | bytes/sec |
| total     | size        | is    | 828.878  | speedup | is    | 915,89    |           |
| sending   | incremental | file  | list     |         |       |           |           |
| ./        |             |       |          |         |       |           |           |
| config.py |             |       |          |         |       |           |           |
|           |             |       |          |         |       |           |           |
| sent      | 11.751      | bytes | received |      38 | bytes | 23.578,00 | bytes/sec |
| total     | size        | is    | 11.62    | speedup | is    | 0,99      |           |
| done      |             |       |          |         |       |           |           |
