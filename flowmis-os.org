...
*** Ver-/Entschlüsselung
**** SSH & GPG/PGP
Vorhandenen Key hinzufügen:
- Mein id_rsa (privater ssh key) und id_rsa.pub in den Ordner ~/.ssh einfügen
- schauen ob er mit dem auf github überinstimmt und ihn hinzufügen über autostartbashskript:
