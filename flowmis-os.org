...
|           |             |       |          |         |       |           |           |
| sent      | 805         | bytes | received |      17 | bytes | 1.644,00  | bytes/sec |
| total     | size        | is    | 833.911  | speedup | is    | 1.014,49  |           |
| sending   | incremental | file  | list     |         |       |           |           |
| ./        |             |       |          |         |       |           |           |
| config.py |             |       |          |         |       |           |           |
|           |             |       |          |         |       |           |           |
| sent      | 11.917      | bytes | received |      38 | bytes | 23.910,00 | bytes/sec |
| total     | size        | is    | 11.784   | speedup | is    | 0,99      |           |
| done      |             |       |          |         |       |           |           |
