...
|                                  |             |       |          |         |       |            |           |
| sent                             | 119.331     | bytes | received |      92 | bytes | 238.846,00 | bytes/sec |
| total                            | size        | is    | 832.464  | speedup | is    | 6,97       |           |
| done                             |             |       |          |         |       |            |           |
:END:
* TODO [#B] flowmis-os [0%]
  - [ ] Wechsel auf Nix OS!
...
sudo pacman -Syu && sudo pacman -S qtile picom fish eza starship alacritty pcmanfm nitrogen sddm neovim fd ripgrep gnupg gpa keepassxc && echo 'Packete updated and installed'
