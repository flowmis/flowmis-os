...
;; Extra - Farben die ich benutze
  ...
  ((cursor :background base4)
   ...
   (org-level-1                 :weight 'bold :underline nil :font "Alegreya Medium" :foreground mane1)
   (org-level-2                 :weight 'bold :underline nil :font "Alegreya Medium" :foreground mane2)
   (org-level-3                 :weight 'bold :underline nil :font "Alegreya Medium" :foreground mane3)
   (org-level-4                 :weight 'normal :underline nil :font "Alegreya Medium" :foreground mane3)
   (org-level-5                 :weight 'normal :underline nil :font "Alegreya Medium" :foreground mane3)
   (org-level-6                 :weight 'normal :underline nil :font "Alegreya Medium" :foreground mane3)
   (org-level-7                 :weight 'normal :underline nil :font "Alegreya Medium" :foreground mane3)
   (org-level-8                 :weight 'normal :underline nil :font "Alegreya Medium" :foreground mane3)
   ...
   (org-todo                    :foreground mane5 :weight 'bold :bold t)
...
(after! org
  ...
  (setq display-line-numbers-type nil                                                                           ;schaltet Zeilennummern aus
        ...
        org-todo-keyword-faces (quote (("EILIG" :foreground "#9d0006" :weight normal)
                                       ("ZEITNAH" :foreground "#d65d0e" :weight normal)
                                       ("IRGENDWANN" :foreground "#c27da7" :weight normal)
                                       ("PAUSIERT" :foreground "#613e53" :weight normal)
                                       ("BEENDET" :foreground "#000000" :weight normal)
                                       ("ABGEBROCHEN" :foreground "#000000" :weight normal)
                                       ("DELEGIERT" :foreground "#613e53" :weight normal)))
