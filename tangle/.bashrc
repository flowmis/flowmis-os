### EXPORT
export TERM="xterm-256color"                      ### EXPORT
...
alias cp="cp -i"            # -r Flag hinzunehmen?
alias mv='mv -i'
alias rm='rm -i'
alias mkdir ='mkdir -pv'    # erstellt auch Childdirectories mit
...
S picom      (picom ist fork von compton)
