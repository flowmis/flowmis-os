mkdir -p ~/.config/{alacritty,qtile,fish} && echo 'Ordner erstellt'
...
sudo pacman -Syu && sudo pacman -S qtile picom fish exa starship alacritty pcmanfm nitrogen sddm emacs-nativecomp neovim fd ripgrep && echo 'Packete updated and installed'
