;;; Datein in Programm ausserhalb Emacs aufmachen -> Videos, Word, Excel,... mit <C-c o> aus dired auch mit mehreren markierten möglich!
...
;Bekomme path nur durch ausführen der Funktion gesetzt - schade dass er nicht fest gesetzt werden kann und manuel aktiviert werden muss
