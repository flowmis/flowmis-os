...
- [[#emacs][Emacs]]
  ...
  - [[#emacs-config---kein-doom][Emacs config - kein Doom]]
...
;; Extra - Farben die ich benutze
  ...
  ((cursor :background base4)
   ...
   (org-level-1                 :weight 'bold :underline nil :foreground mane1)
   (org-level-2                 :weight 'bold :underline nil :foreground mane2)
   (org-level-3                 :weight 'bold :underline nil :foreground mane3)
   (org-level-4                 :weight 'normal :underline nil :foreground mane3)
   (org-level-5                 :weight 'normal :underline nil :foreground mane3)
   (org-level-6                 :weight 'normal :underline nil :foreground mane3)
   (org-level-7                 :weight 'normal :underline nil :foreground mane3)
   (org-level-8                 :weight 'normal :underline nil :foreground mane3)
