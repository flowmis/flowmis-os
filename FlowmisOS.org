...
(map! :leader
       :desc "end of line" "<right>" #'end-of-line
       :desc "start of line" "<left>" #'beginning-of-line
       :desc "page down" "<down>" #'evil-scroll-page-down
       :desc "page up" "<up>" #'evil-scroll-page-up
