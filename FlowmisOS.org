...
- was brauche ich um qtile config funktionieren zu lassen
#+begin_src sh :tangle tangle/verschieben.sh
mkdir -p ~/.config/{rofi,alacritty,picom,qtile,doom}
cp -r /home/flowmis/FlowmisOS/init.el /home/flowmis/.config/doom/init.el
cp -r /home/flowmis/FlowmisOS/packages.el /home/flowmis/.config/doom/packages.el
cp -r /home/flowmis/FlowmisOS/config.el /home/flowmis/.config/doom/config.el
cp -r /home/flowmis/FlowmisOS/.xprofile /home/flowmis/.xprofile
cp -r /home/flowmis/FlowmisOS/config.py /home/flowmis/.config/qtile/config.py
cp -r /home/flowmis/FlowmisOS/config.rasi /home/flowmis/.config/rofi/config.rasi
...
4. folgende Befehle eingeben(Befehle kann ich auch als shell script auf Bootstick und von dort aus starten):
 ...
 cd FlowmisOS
 . rootinstall.sh
 #geht durch Skript?  EDITOR=nvim visudo          -> uncomment #%wheel ALL=(ALL) ALL
 exit
 umount -l /mnt
 reboot                      -> & login
 cd FlowmisOS
...
1. Installation eines Linux Betriebssystems
...
2. Erstelle Dateien für die Installation
   1. Datei die dem Gerät einen Namen gibt
    #+begin_src shell :tangle tangle/locale.conf
    LANG=de_DE.UTF-8
    LC_CTYPE=de_DE.UTF-8
    #+end_src
   2. Datei die den localhost und die localdomain festlegt
...
3. Root Installationsskript: ~Achtung!!!~ bei Installation Video/Grafiktreiber muss Skript auf VM/physisches Gerät angepasst werden!
...
- Die Qtile Konfigurationsdatei muss in /home/flowmis//.config/qtile kopiert werden
