...
- [[#installation][Installation]]
  ...
  - [[#ohne-installskript][Ohne Installskript]]
  - [[#mit-installskript][Mit Installskript]]
- [[#emacs][Emacs]]
...
- Ich muss hier mehr selbst einstellen und brauche z.B. folgendes Skript
...
--> Weiter geht es dann wie wenn es mit Installskript installiert wird...
...
10. MinimalInstall.sh ausführen: ~. ~/FlowmisOS/tangled/MinimalInstall.sh~
...
*** Modulare Installation über src-blocks
...
#+begin_src sh
cd ~ && git clone https://aur.archlinux.org/yay-git.git && cd ~/yay-git/ && makepkg -si && rm -rf ~/yay-git/ && yay -Syu && cd ~ && rm -rf ~/yay-git/ && yay -S dropbox sddm-sugar-dark archlinux-tweak-tool-git termite otf-alegreya-sans mu && echo '###########################installed yay###########################'
#+end_src

***** Mein Doom Emacs

Zuerts Yay und Yay Packages installieren! Dann folgendes und Emacs sollte beim doomdoctor keine Probleme/Warnungen mehr ausgeben!
