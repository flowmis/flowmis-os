...
- Meine Backup der Daten erfolgt wie hier erklärt (Alternativ kann ich es auch mit git machen - siehe git):
...
- Pull Request:
  1.
**** SSH & Github
**** Backup Data on cold storage (Festplatte) with git:
...
# sudo g810-led -k logo 723535                      # setzt Farbeinstellungen für meine Logitech Tastatur
# sudo g810-led -fx color keys 723535               # setzt Farbeinstellungen für meine Logitech Tastatur
# loadkeys de-latin1 &
