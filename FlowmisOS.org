...
;; Extra - Farben die ich benutze
  ...
  ((cursor :background base4)
   ...
   (org-footnote                :foreground mane1 :underline t)
...
(after! org
  ...
  (setq display-line-numbers-type nil                                                                           ;schaltet Zeilennummern aus
        ...
        org-todo-keyword-faces (quote (("EILIG" :foreground "#ffa566" :weight bold)
                                       ("ZEITNAH" :foreground "#ffa566" :weight bold)
                                       ("IRGENDWANN" :foreground "#ffa566" :weight bold)
...
* ZEITNAH FlowmisOS
:LOGBOOK:
- State "ZEITNAH"    from              [2022-08-17 Mi 09:42] \\
  Zu TODOs hinzugefügt
:END:
...
- [ ] YASNIPPETS FEHLERMELDUNG BEHEBEN
