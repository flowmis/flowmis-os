...
** Qtile
Das ist sehr nett von Ihnen! Ich habe bereits Kontakt mit Herrn Karsten gehabt und wende mich bezüglich datenschutzrechtlicher Belange, wie von ihm empfohlen, an den Datenschutzbeauftragten meiner Schule. Herr Karsten sieht keine Probleme, wenn ich keine personenbezogenen Daten speichere bzw. verarbeite. Vom Datenschutzbeauftragten meiner Schule habe ich noch keine Rückmeldung. Ich denke, wie geplant, passt es. Falls Sie dennoch auf etwas stoßen, geben Sie mir gerne Bescheid. Der Link vom ahs-institut erklärt es tatsächlich gut (auch wenn der Einsatz im eigentlichen Unterricht für Schülerinnen und Schüler und der Chemiebezug nicht wirklich angesprochen werden), und er war mir bisher unbekannt. Hätte ich ihn früher entdeckt, hätte mir das Erstellen meines Exposés erleichtert. Aber auch so denke ich, dass er noch hilfreich sein kann, weshalb ich mich kurz für die Weitergabe bedanken wollte!
#+begin_src sh  :dir /sudo::
...
Für die Installation: Erst yay und yay Packages installieren! Dann folgendes:
...
(setq org-gcal-client-id "795575166080-k7kfqlbb328fltfkq002omkso0khg652.apps.googleusercontent.com"
      ...
      org-gcal-file-alist '(("manemarkushoffmann@gmail.com" .  "~/cloud/life/raum/.org/roam-orga/gcal.org")))
