...
(with-eval-after-load 'org
  ...
  (define-key org-mode-map (kbd "M-s") #'mane-presentation-mode)
  (define-key org-mode-map (kbd "M-S") #'mane-writing-mode)
...
- Schriftart und Spacing mit Fontaine und Spacious-Padding sind im Unterpunkt Erscheinungsbild festgelegt. Ich habe in fontaine die Variable pres auf die ich mich hier beziehen kann, um die Schriftart in einem Modus anzupassen und kann theoretisch auch anderen dort hinzufügen!?
