...
- [[#magit--timemachine][Magit + Timemachine]]
- [[#gpt--llms][GPT & LLMs]]
...
- Denote consult
- [[https://lucidmanager.org/productivity/denote-explore/][Denote explore]]
#+begin_src elisp
(use-package denote
  :ensure t)
...
(setq denote-known-keywords '("kl8" "kl9" "kl10" "ch" "spo" "nwt" "tauchen" "crypt" "vb" "hb" "fb" "bb" "bag" "lsw" "projekt" "archiv" "eigvid"))
...
(use-package vterm-toggle
  ...
  (add-to-list 'display-buffer-alist
               '((lambda (buffer-or-name _)
                  ...
                  (window-height . 0.3))))
#+end_src
* TODO [[https://github.com/wdavew/org-excalidraw][Excalidraw]]
#+begin_src elisp
;; (use-package org-excalidraw
  ;; :ensure t
  ;; '(org-excalidraw :host github :repo "wdavew/org-excalidraw"))
#+end_src
* Export
...
* [[https://magit.vc/manual/][Magit]] + [[https://github.com/emacsmirror/git-timemachine][Timemachine]] 
Timemachine in einem offenen file aktivieren mit 'SPC g t' (muss git repo sein)
Mit 'CTRL-j' and 'CTRL-k' durch die commits hindurch switchen und nehmen was man will und es dann speichern und neu commiten etc.
...
(use-package org-caldav
  ...
  (setq org-caldav-url "https://cloud.pyroma.net/remote.php/dav/calendars/mane"
	  ...
	  org-caldav-save-directory "~/cloud/life/zeit/archiv/"     ; um sync von mehreren Geräten zu ermöglichen brauchen sie die gleiche historie (mit org-caldav-delete-everything kann ich die vorhergehende historie löschen)
