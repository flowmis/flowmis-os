...
- [[#git][Git]]
- [[#gpt--llms][GPT & LLMs]]
- [[#minibuffer-und-complete-anything-company][Minibuffer und Complete Anything (Company)]]
- [[#kalender][Kalender]]
- [[#mail][Mail]]
- [[#makros][Makros]]
...
(use-package gptel   ;id-tranclusion-gpt
 ...
 (setq gptel-api-key ""))
#+end_src
* Minibuffer und Complete Anything (Company)
- Alternativen: company, company-box, counsel, orderless, ivy, all-the-icons-ivy-rich, ivy-rich, helm,... -> aktuell ist es wie [[https://www.youtube.com/watch?v=d3aaxOqwHhI][hier]] 
