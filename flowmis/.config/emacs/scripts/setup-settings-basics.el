...
(use-package general
  ...
  (mane-leader-keys
    ...
    "h r" '((lambda () (interactive)(load-file "~/.config/emacs/init.el")(ignore (elpaca-process-queues))) :wk "Reload emacs config")
    ...
    "n f" '(denote-find-link :wk "Find a Note")
    ...
    "o l" '(org-insert-link :wk "Link einfügen")
    "o p" '(org-store-link :wk "Speichert Link at point")
